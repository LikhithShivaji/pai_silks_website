 ...
 *
 * Nothing in this file is service-specific: it formats express-validator's
 * output and rejects non-scalar body values. The rules themselves live in each
 * service's own `middlewares/validators.js`, which is where the differences
 * belong.
 */
