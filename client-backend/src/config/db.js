 ...
 * (`root` / `admin123` / `db`). Because this service had no .env file at all,
 * those fallbacks were not a safety net — they were the live configuration,
 * with a password written in plain text in a public repository.
 *
 ...
 * that refuses to start. See CLAUDE.md CB-10.
 *
