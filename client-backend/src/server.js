...
// without picking one. `Number(process.env.PORT) || 9034` treated that 0 as
// "unset" and silently bound 9034 instead, so a caller asking for an ephemeral
...
const server = app.listen(PORT, () => {
  ...
  //                                     "Server running on port 9034" for a
  ...
  // what speaks when the bind fails. See CLAUDE.md CB-37.
